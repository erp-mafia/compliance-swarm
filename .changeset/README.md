...
This directory contains changesets for `compliancemaxx`. Each user-facing
...
Pick the affected package(s) (`compliancemaxx`), choose the version bump
...
2. When that PR is merged → publishes to npm, tags `vX.Y.Z`, and force-moves
   ...
   `uses: erp-mafia/compliancemaxx@v1` always get the latest 1.x.
